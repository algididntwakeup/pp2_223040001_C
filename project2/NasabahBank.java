...
public class NasabahBank extends JFrame{
    ...
    public NasabahBank(){
        ...
        // Membuat jenis tipe rekening menggunakan JList
        String[] tabungan = {"Silver GPN", "Silver Visa", "Gold JCB", "Platinum JCB"};
        ...
        menuItemExit.getAccessibleContext().setAccessibleDescription("Keluar aplikasi");
        menu.add(menuItemExit);

        // JSlider buat frekuensi
